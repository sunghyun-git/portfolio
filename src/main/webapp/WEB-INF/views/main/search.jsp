    ...
    // 정상적으로 검색이 완료됐으면 
     ...
     var coords = new kakao.maps.LatLng(result[0].y, result[0].x);
        ...
        kakao.maps.event.addListener(marker, 'click', function() {
            ...
            if(photo[index] == ""){
                infowindow.setContent('<a href="../restaurant?cid='+placecid[index]+'"><div style="text-align:center;"><img src="/resources/img/eatchelin.png" height="105px;" width="105px;"></div><div style="width:auto;height:auto;padding:5px;font-size:15px; color:black;">' +placena[index] +' '+rating[index] + '<br>'+catename[index]+'</div><a>');
            }
            else{
                infowindow.setContent('<a href="../restaurant?cid='+placecid[index]+'"><div style="text-align : center; overflow : hidden";><img src="'+photo[index]+'" height="105px;" width="105px;" ></div> <div style="width:auto;height:auto;padding:5px;font-size:15px; color:black;">' +placena[index] +' '+rating[index] +'<br>'+catename[index]+'</div><a>');
