...
<form method="post" action="/restaurantreview/modify" role="form">
...
<input type="hidden" name="rw" value="${review.rw_no }">
...
<c:if test="${ review.rw_photo!=null}">
<h1>이미 쓰고 있는 사진</h1>
<br>
<img src="${review.rw_photo }" width="100" height="100">
</c:if>
<br><br>
...
<div class='uploadResult'>
	...
	<br>
	<button type="submit">음식점 리뷰 수정하기</button>
	<input type="button" value="삭제하기" onclick="location.href='/restaurantreview/delete/?rw=${review.rw_no}&cid=${restaurant.cid}'">
